    ...
    <div className="w-full max-w-md">
      ...
      <Card>
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-xl tracking-[-0.06em]">Criar conta</CardTitle>
          <CardDescription>
            A conta é criada automaticamente via GitHub. Somente membros da organização autorizada
            podem se cadastrar.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="rounded-[10px] bg-muted p-4">
            <h4 className="mb-2 text-sm font-medium tracking-[-0.04em]">Como funciona?</h4>
