...
import { Search, Map, Loader2, X, ChevronLeft, ChevronRight } from "lucide-react";
    ...
    <main className="min-h-screen bg-background">
      <section className="px-6 pb-8 pt-32">
        <div className="mx-auto max-w-6xl text-center">
          <h1 className="text-primary">Terrenos</h1>
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20">
              ...
              <p className="mt-2 text-muted-foreground">
                {hasFilters ? "Tente ajustar os filtros." : "Ainda não há terrenos cadastrados."}
              </p>
              <div className="mt-6">
                <Link href="/crm">
